## Floating-Point Arithmetic (40 min)

### 1.0 Representation of Numbers (Overview)
...
### 1.2 32-bit Floating Point Format
...
### 1.4 Summary: Floating-Point Arithmetic Rules
...
### 1.5 Precision and Rounding Errors
